...
public:
  ...
  */
  ExtractPositiveTrainingClusters() 
  {
    ...
    if (!nh_private.getParam("base_laser", base_laser_))
      ROS_ERROR("Couldn't get base_laser from ros param server");
  ...
  void extract()
  {
    ...
    BOOST_FOREACH(rosbag::MessageInstance const m, view)
    {
      ...
      if (scan != NULL)
      {
        ...
        leg_cluster_positions.header.frame_id = base_laser_;
